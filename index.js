(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		...
		exports["window-event-mediator"] = factory();
	else
		root["window-event-mediator"] = factory();
})(this, function() {
...
/***/ function(module, exports, __webpack_require__) {
	 ...
	 */
	var WindowEventMediator, debounce, defaults, forEachRight, remove, throttle,
	  bind = function(fn, me){ return function(){ return fn.apply(me, arguments); }; };

	defaults = __webpack_require__(1);

	forEachRight = __webpack_require__(53);

	throttle = __webpack_require__(65);

	debounce = __webpack_require__(66);

	remove = __webpack_require__(70);
	...
	WindowEventMediator = (function() {
	  ...
	  WindowEventMediator.prototype.on = function(event, callback, options) {
	    ...
	    options = defaults(options, this.defaults);
	  ...
	  WindowEventMediator.prototype.off = function(event, callback, options) {
	    ...
	    if (options != null) {
	      ...
	      if (this.handlers[event][key] != null) {
	        return remove(this.handlers[event][key], function(cbs) {
	          return cbs.original === callback;
	        });
	      }
	    } else {
	      ref = this.handlers[event];
	      results = [];
	      for (i = 0, len = ref.length; i < len; i++) {
	        arr = ref[i];
	        results.push(remove(arr, function(cbs) {
	          return cbs.original === callback;
	        }));
	      }
	      return results;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var apply = __webpack_require__(2),
	    assignInWith = __webpack_require__(3),
	    baseRest = __webpack_require__(24),
	    customDefaultsAssignIn = __webpack_require__(52);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var arrayEachRight = __webpack_require__(54),
	    baseEachRight = __webpack_require__(55),
...
/***/ function(module, exports, __webpack_require__) {
	...
	var baseForOwnRight = __webpack_require__(56),
...
/***/ function(module, exports, __webpack_require__) {
	...
	var baseForRight = __webpack_require__(57),
...
/***/ function(module, exports, __webpack_require__) {
	...
	var baseUnset = __webpack_require__(149),
	    isIndex = __webpack_require__(34);
